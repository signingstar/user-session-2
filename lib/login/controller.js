...
var loginController = function loginController(_ref) {
  ...
  return {
    get: function get(_ref2) {
      ...
      var _headerPresenter = (0, _tiskoHeader2.default)({ cookies: cookies, topNav: false }, page);
    ...
    post: function post(_ref3) {
      ...
      (0, _verify_login2.default)(userid, password, function (isValid) {
        if (isValid) {
          ...
          (0, _tiskoHeader2.default)({ topNav: false }, page);

          page.set(pageConfig);
          page.set({
            refUrl: (0, _presenter.presenter)(req.query.ref_url),
